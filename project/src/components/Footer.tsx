          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+918100677351" className="text-gray-300 hover:text-primary transition-colors">
                  +91 81006 77351
                </a>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <a href="https://wa.me/918100677351" className="text-gray-300 hover:text-primary transition-colors">
                  WhatsApp Us
                </a>
              </div>
            </div>
